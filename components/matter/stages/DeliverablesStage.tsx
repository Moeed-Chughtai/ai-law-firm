    ...
    <div className="space-y-8 animate-slide-up">
      ...
      <div className="flex items-start gap-2.5 p-3 bg-gray-50 rounded-lg border border-gray-100">
        ...
        <p className="text-xs text-gray-500 leading-relaxed">
          <span className="font-semibold text-gray-700">Important:</span> These deliverables are generated by AI and should be reviewed by qualified legal counsel before taking action. LegalSwarm provides analysis to assist — not replace — professional legal judgment.
        </p>
      </div>
    </div>
  );
